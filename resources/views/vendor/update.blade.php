                  ...
                  <div class="card-body">
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="name" name="name" value="{{ $data[0]->name }}" placeholder="Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-sm-6">
                               <input type="text" class="form-control" id="contactPerson" name="contactPerson" value="{{ $data[0]->cp }}" placeholder="Contact Person">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="phone" name="phone" value="{{ $data[0]->phone }}" placeholder="Phone No">
                            </div>
                        </div>
                        <div class="col-md-4">
