                  ...
                  <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="name" value="{{ $data[0]->name }}" name="name" placeholder="Name" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="purchasePrice" value="{{ $data[0]->purchase_price }}" name="purchasePrice" placeholder="Purchase Price" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label for="sellingPrice" class="col-sm-4 col-form-label">Selling Price</label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="sellingPrice" value="{{ $data[0]->selling_price }}" name="sellingPrice" placeholder="Selling Price" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-12">
                                <textarea name="information" class="form-control" rows="4" disabled>{{ $data[0]->information }}</textarea>
                            </div>
                        </div>
                    </div>
